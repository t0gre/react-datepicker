...
function parse(e, t) {
  ...
  if (s) {
    var i,
      u = s.getTime(),
      f = 0
    if ((n.time && (f = parseTime(n.time)), n.timezone))
      ...
      var _ = new Date(d)
      _.setDate(c.getDate() + 1)
      var D = getTimezoneOffsetInMilliseconds(_) - getTimezoneOffsetInMilliseconds(c)
      D > 0 && (i += D)
    }
...
function getDays(e) {
  var t = e.year,
    ...
    f = get_day(u),
    d = end_of_month(i),
    c = Array.from(Array(f >= a ? f - a : a).keys()).fill(0),
    _ = each_day(u, d).map(function(e) {
...
function isStartOrEndDate(e, t, r) {
  return !!((t && is_same_day(e, t)) || (r && is_same_day(e, r)))
}
function isDateBlocked(e, t, r, n) {
  return !!((t && is_before(e, t)) || (r && is_after(e, r)) || (n && n(e)))
}
...
function getNextActiveMonth(e, t, r) {
  ...
  return Array.from(Array(t).keys()).reduce(function(e) {
    return (n = add_months(n, r)), e.concat([getDateMonthAndYear(n)])
  }, [])
}
...
function useDatepicker(e) {
  var t = e.startDate,
    ...
    l = react.useCallback(
      function(e) {
        return isStartOrEndDate(e, t, r)
      },
      [t, r],
    ),
    m = react.useCallback(
      function(e) {
        return isDateBlocked(e, a, o)
      },
      [a, o],
    )
  return {
...
;(exports.END_DATE = END_DATE),
  ...
  (exports.isStartOrEndDate = isStartOrEndDate),
