...
export declare function useDatepicker({ startDate, endDate, focusedInput, minBookingDate, maxBookingDate, onDateChange, exactMinBookingDays, minBookingDays, numberOfMonths, firstDayOfWeek, isDayBlocked: isDayBlockedProps, }: UseDatepickerProps): {
    firstDayOfWeek: FirstDayOfWeek;
