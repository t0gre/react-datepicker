...
function Day(e) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        Text,
        {color: s, fontFamily: 'Montserrat', fontWeight: 500, fontSize: '14px'},
        t,
      ),
    ),
  )
...
var templateObject_1$6,
  ...
  Month = function(e) {
    var t = e.year,
      ...
      c = e.onDaySelect,
      l = ne({year: t, month: n, weekStartsOn: r}),
      s = l.days,
      u = l.weekDays,
      p = l.monthLabel
    return React__default.createElement(
...
function Datepicker(e) {
  var t = e.startDate,
    ...
    m = f.activeMonths,
    _ = f.isDateSelected,
    y = f.isStartOrEndDate,
    g = f.isDateBlocked,
    h = f.firstDayOfWeek,
    b = f.onDaySelect,
    v = f.onResetDates,
    x = f.goToPreviousMonths,
    D = f.goToNextMonths
  return React__default.createElement(
    StyledDatepicker,
    ...
    React__default.createElement(
      Box,
      {mt: '32px'},
      React__default.createElement(ResetDates, {onResetDates: v}),
    ),
  )
}
...
function DateRangeInput(e) {
  var t = e.startDate,
    ...
    s = e.onDateChange,
    u = e.displayFormat,
    p = void 0 === u ? 'MM/DD/YYYY' : u,
    d = e.phrases,
    f = void 0 === d ? dateRangeInputPhrases : d,
    m = React.useRef(null)
  function _(e) {
    null !== l && m && m.current && !m.current.contains(e.target) && i(null)
  }
  return (
