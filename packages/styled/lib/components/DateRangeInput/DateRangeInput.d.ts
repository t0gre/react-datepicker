import { GridTemplateColumnsProperty, BackgroundProperty, BorderProperty, BorderRadiusProperty, MinHeightProperty, TopProperty, PaddingProperty, ColorProperty, GlobalsNumber, HeightProperty, BottomProperty, LeftProperty } from 'csstype';
...
declare function DateRangeInput({ startDate, endDate, minBookingDate, maxBookingDate, firstDayOfWeek, onFocusChange, numberOfMonths, focusedInput, onDateChange, showStartDateCalendarIcon, showEndDateCalendarIcon, styles, displayFormat, phrases, }: DateRangeInputProps): JSX.Element;
