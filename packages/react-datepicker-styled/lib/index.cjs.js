...
function Input() {
    return (React__default.createElement(InputLabel, { htmlFor: "test", display: "block", position: "relative", border: "1px solid #d0d0d0", background: "#ffffff", borderRadius: "2px" },
        React__default.createElement(CalendarWrapper, { position: "absolute", height: "12px", width: "12px", top: "18px", left: "16px" },
            React__default.createElement(CalendarIcon, { width: "12px", height: "12px", color: "#BCBEC0" })),
        React__default.createElement(StyledInput, { border: "0", px: "44px", width: "100%", height: "46px", background: "#ffffff", fontFamily: "Montserrat", color: "#001217", fontSize: "14px", fontWeight: 600, id: "test", placeholder: "Set end date", readOnly: true })));
}
...
var StyledDay = styled('div')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", "\n  ", "\n  ", "\n  ", "\n  cursor: pointer;\n  \n  ", "\n  \n  ", "\n"], ["\n  ", "\n  ", "\n  ", "\n  ", "\n  cursor: pointer;\n  \n  ",
    "\n  \n  ",
...
function Day(_a) {
    var day = _a.day, isActive = _a.isActive, isStartOrEnd = _a.isStartOrEnd, disabled = _a.disabled;
    ...
    return (React__default.createElement(StyledDay, { disabled: disabled, isActive: isActive, isStartOrEnd: isStartOrEnd, height: "36px", width: "36px", background: background, boxShadow: "1px 0 0 0 " + borderColor + ",\n        0 1px 0 0 " + borderColor + ",\n        1px 1px 0 0 " + borderColor + ",\n        1px 0 0 0 " + borderColor + " inset,\n        0 1px 0 0 " + borderColor + " inset" },
...
var Month = function (_a) {
    var year = _a.year, month = _a.month, firstDayOfWeek = _a.firstDayOfWeek, isDateBlocked = _a.isDateBlocked, isDateSelected = _a.isDateSelected, isStartOrEndDate = _a.isStartOrEndDate;
    ...
    return (React__default.createElement("div", null,
        ...
        React__default.createElement(Grid, { gridTemplateColumns: "repeat(7, 36px)" }, days.map(function (day, index) {
            if (typeof day === 'object') {
                return (React__default.createElement(Day$1, { isActive: isDateSelected(day.date), key: day.day, day: day.day, disabled: isDateBlocked(day.date), isStartOrEnd: isStartOrEndDate(day.date) }));
            }
    ...
    return (React__default.createElement(StyledDatepicker, { background: "#ffffff", p: "32px", borderRadius: "2px" },
        React__default.createElement(DateWrapper, null,
            React__default.createElement(Grid, { gridTemplateColumns: "126px 75px 126px" },
                React__default.createElement(Date$1, { title: "Start date:", date: "Select", isActive: true }),
        ...
        React__default.createElement(Box, { mt: "32px" },
            React__default.createElement(ResetDates, null))));
}
...
function DateRangePicker(_a) {
    ...
    return (React__default.createElement("div", null,
        React__default.createElement(Grid, { gridTemplateColumns: "194px 39px 194px" },
            ...
            React__default.createElement(Input, null)),
        React__default.createElement(Datepicker, { startDate: startDate, endDate: endDate, minBookingDate: minBookingDate, maxBookingDate: maxBookingDate, firstDayOfWeek: firstDayOfWeek, onFocusChange: onFocusChange, numberOfMonths: numberOfMonths, focusedInput: focusedInput })));
}
