  ...
  !(function(e) {
                  ...
                  if (je > 0)
                    switch (A) {
                      ...
                      case te:
                        if (
                          ((Ue =
                            (Te = Te.replace(b, '$1 $2' + (Be > 0 ? De : ''))) + '{' + Ue + '}'),
                          1 === Ae || (2 === Ae && Le('@' + Ue, 3)))
                        )
                          Ue = '@' + N + Ue + '@' + Ue
                        else Ue = '@' + Ue
              ...
              ? (function(e) {
                  for (var a, r, s = 0, t = e.length, i = Array(t); s < t; ++s) {
                    for (
                      ...
                      if (
                        ((u = n.charCodeAt(n.length - 1)), (d = r.charCodeAt(0)), (a = ''), 0 !== o)
                      )
                        switch (u) {
                          case T:
                          case ae:
    ...
    function Ke(e, a, r, c) {
      ...
      switch (u) {
        ...
        case 1e3:
          switch (
            ((o = (l = h.substring(13).trim()).indexOf('-') + 1), l.charCodeAt(0) + l.charCodeAt(o))
          ) {
            case 226:
              l = h.replace(m, 'tb')
              break
        ...
        case 938:
          if (h.charCodeAt(5) === Q)
            switch (h.charCodeAt(6)) {
              ...
              default:
                return (
                  N + h + F + 'flex-line-pack' + h.replace('align-content', '').replace(y, '') + h
                )
            }
          break
        case 973:
        ...
        case 962:
          if (
            ...
            r + c === 211 && 105 === h.charCodeAt(13) && h.indexOf('transform', 10) > 0)
          )
...
var StyleSheet = (function() {
  ...
  StyleSheet.prototype.rehydrate = function rehydrate$$1() {
    ...
    var nodes = document.querySelectorAll(
      'style[' + SC_ATTR + '][' + SC_VERSION_ATTR + '="' + '4.2.0' + '"]',
    )
...
var classNameUsageCheckInjector = function(target) {
  ...
  target.componentDidMount = function componentDidMount() {
    ...
    var classNames = elementClassName
      .replace(/\s+/g, ' ')
      .trim()
      .split(' ')
    // eslint-disable-next-line react/no-find-dom-node
    var node = ReactDOM.findDOMNode(this)
    var selector = classNames
      .map(function(s) {
        return '.' + s
      })
      .join('')
    ...
    if (
      ...
      console.warn(
        "It looks like you've wrapped styled() around your React component (" +
          getComponentName(forwardTarget) +
...
var style = function style(_ref) {
  ...
  func.propTypes = ((_func$propTypes = {}),
  (_func$propTypes[prop] = cloneFunction(propType)),
  _func$propTypes)
...
var variant = function variant(_ref3) {
  ...
  (_fn$propTypes[prop] = propTypes.oneOfType([propTypes.number, propTypes.string])),
  _fn$propTypes)
  return fn
} // space
...
function differenceInCalendarDays(dirtyDateLeft, dirtyDateRight) {
  ...
  var timestampRight =
    startOfDayRight.getTime() - startOfDayRight.getTimezoneOffset() * MILLISECONDS_IN_MINUTE$2 // Round the number of days to the nearest integer
...
function differenceInCalendarISOWeeks(dirtyDateLeft, dirtyDateRight) {
  ...
  var timestampRight =
    ...
    startOfISOWeekRight.getTimezoneOffset() * MILLISECONDS_IN_MINUTE$4 // Round the number of days to the nearest integer
...
function differenceInCalendarWeeks(dirtyDateLeft, dirtyDateRight, dirtyOptions) {
  ...
  var timestampRight =
    startOfWeekRight.getTime() - startOfWeekRight.getTimezoneOffset() * MILLISECONDS_IN_MINUTE$5 // Round the number of days to the nearest integer
  // because the number of milliseconds in a week is not constant
  // (e.g. it's different in the week of the daylight saving time clock shift)
...
function isDateBlocked(date, minBookingDate, maxBookingDate, isDayBlockedFn) {
  return !!(
    (minBookingDate && dateFns_70(date, minBookingDate)) ||
...
function useDatepicker(_a) {
  ...
  var isDateSelected$1 = React.useCallback(
    function(date) {
      return isDateSelected(date, startDate, endDate)
    },
    [startDate, endDate],
  )
  var isStartOrEndDate$1 = React.useCallback(
    function(date) {
      return isStartOrEndDate(date, startDate, endDate)
    },
    [startDate, endDate],
  )
  var isDateBlocked$1 = React.useCallback(
    function(date) {
...
var dateRangeInputPhrases = __assign({}, datepickerPhrases, {
...
var Month = function(_a) {
  var year = _a.year,
    ...
    isStartOrEndDate = _a.isStartOrEndDate,
    onDaySelect = _a.onDaySelect
  var _b = useMonth({year: year, month: month, weekStartsOn: firstDayOfWeek}),
    days = _b.days,
...
function ResetDates(_a) {
  ...
  return React__default.createElement(
    Flex,
    {role: 'button', onClick: onResetDates, alignItems: 'center'},
...
function Datepicker(_a) {
  var startDate = _a.startDate,
    ...
    _c = _a.phrases,
    phrases = _c === void 0 ? datepickerPhrases : _c
  var _d = useDatepicker({
    ...
    activeMonths = _d.activeMonths,
    isDateSelected = _d.isDateSelected,
    isStartOrEndDate = _d.isStartOrEndDate,
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(NavButton, {type: 'prev', onClick: goToPreviousMonths}),
      ),
      React__default.createElement(
        Box,
        {position: 'absolute', top: '-5px', right: '0'},
        React__default.createElement(NavButton, {type: 'next', onClick: goToNextMonths}),
      ),
      React__default.createElement(
        Grid,
