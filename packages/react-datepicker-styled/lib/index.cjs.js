...
var compose = function compose() {
  ...
  funcs.forEach(function (fn) {
    func.propTypes = _extends$1({}, func.propTypes, fn.propTypes);
  });
  return func;
};
...
function getWeekDays(_a) {
  var _b = _a === void 0 ? {} : _a,
      ...
      _d = _b.weekDayFormat,
      weekDayFormat = _d === void 0 ? function (date) {
...
function getDays(_a) {
  var year = _a.year,
      ...
      _c = _a.dayFormat,
      dayFormat = _c === void 0 ? function (date) {
    return dateFns_50(date, 'DD');
  } : _c;
...
function useMonth(_a) {
  var year = _a.year,
    ...
    return dateFns_50(date, 'dd');
      ...
      monthLabelFormat = _e === void 0 ? function (date) {
...
function isDateBlocked(date, minBookingDate, maxBookingDate, isDayBlockedFn) {
  return !!(minBookingDate && dateFns_70(date, minBookingDate) || maxBookingDate && dateFns_69(date, maxBookingDate) || isDayBlockedFn && isDayBlockedFn(date));
}
...
function useDatepicker(_a) {
  ...
  var isDateSelected$1 = React.useCallback(function (date) {
    return isDateSelected(date, startDate, endDate);
  }, [startDate, endDate]);
  var isStartOrEndDate$1 = React.useCallback(function (date) {
    return isStartOrEndDate(date, startDate, endDate);
  }, [startDate, endDate]);
  var isDateBlocked$1 = React.useCallback(function (date) {
    return isDateBlocked(date, minBookingDate, maxBookingDate);
  ...
  function onDaySelect(date) {
    if (focusedInput === END_DATE && startDate && dateFns_70(date, startDate) || focusedInput === START_DATE && endDate && dateFns_69(date, endDate)) {
      onDateChange({
        endDate: null,
        startDate: date,
...
function Input(_a) {
    ...
    return (React__default.createElement(InputLabel, { htmlFor: id, display: "block", position: "relative", border: "1px solid #d0d0d0", background: "#ffffff", borderRadius: "2px", onClick: onClick },
        React__default.createElement(CalendarWrapper, { position: "absolute", height: "12px", width: "12px", top: "16px", left: "16px" },
            React__default.createElement(CalendarIcon, { width: "12px", height: "12px", color: "#BCBEC0" })),
        React__default.createElement(StyledInput, { border: "0", px: "44px", width: "100%", height: "46px", background: "#ffffff", fontFamily: "Montserrat", color: "#001217", fontSize: "14px", fontWeight: 600, id: id, placeholder: placeholder, "aria-label": ariaLabel, value: value, autoComplete: "off", readOnly: true })));
}
...
function ArrowIcon(_a) {
    ...
    return (React__default.createElement("svg", { width: width, height: height, className: className, color: color, transform: "rotate(" + angle + " 0 0)", viewBox: "0 0 9 12", xmlns: "http://www.w3.org/2000/svg" },
        React__default.createElement("path", { fill: "currentColor", d: "M4.46.001a.538.538 0 0 0-.358.174L.156 4.48a.538.538 0 1 0 .796.724l3.01-3.285v13.689a.563.563 0 0 0 .538.55.563.563 0 0 0 .538-.55V1.918l3.01 3.286a.538.538 0 1 0 .796-.724L4.898.175a.538.538 0 0 0-.437-.174z" })));
}
...
var StyledDate = styled(Text)(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  position: relative;\n  display: inline-block;\n\n  &:after {\n    content: '';\n    position: absolute;\n    height: 2px;\n    width: 100%;\n    bottom: 0;\n    left: 0;\n    z-index: 1;\n  }\n\n  ", "\n"], ["\n  position: relative;\n  display: inline-block;\n\n  &:after {\n    content: '';\n    position: absolute;\n    height: 2px;\n    width: 100%;\n    bottom: 0;\n    left: 0;\n    z-index: 1;\n  }\n\n  ",
    "\n"])), function (_a) {
    var isActive = _a.isActive;
    return isActive && css(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n      &:after {\n        background: #00aeef;\n      }\n    "], ["\n      &:after {\n        background: #00aeef;\n      }\n    "])));
});
function Date$1(_a) {
    var title = _a.title, isActive = _a.isActive, _b = _a.date, date = _b === void 0 ? 'Select' : _b;
    return (React__default.createElement("div", null,
        React__default.createElement(Text, { fontFamily: "Montserrat", fontSize: "11px", color: "#929598", mb: "8px" }, title),
        React__default.createElement(StyledDate, { as: "span", color: "#001217", fontSize: "24px", fontWeight: 500, fontFamily: "Montserrat", pb: "15px", isActive: isActive }, date)));
}
...
var MonthLabel = function (_a) {
    var label = _a.label;
    return (React__default.createElement(Text, { fontFamily: "Montserrat", fontSize: "14px", fontWeight: 600, lineHeight: 1.57, color: "#343132" }, label));
};
...
var MonthLabel$1 = function (_a) {
    var label = _a.label;
    return (React__default.createElement(Text, { fontFamily: "Montserrat", fontSize: "11px", fontWeight: 500, color: "#929598" }, label));
};
//# sourceMappingURL=DayLabel.js.map

//# sourceMappingURL=index.js.map

var StyledDay = styled('button')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", "\n  ", "\n  ", "\n  ", "\n  cursor: pointer;\n  border: 0;\n  padding: 0;\n  outline: 0;\n  \n  ", "\n  \n  ", "\n"], ["\n  ", "\n  ", "\n  ", "\n  ", "\n  cursor: pointer;\n  border: 0;\n  padding: 0;\n  outline: 0;\n  \n  ",
    "\n  \n  ",
    "\n"])), width, height, boxShadow, background, function (_a) {
    var disabled = _a.disabled;
    return disabled && css(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n      cursor: initial;\n      opacity: 0.4;\n    "], ["\n      cursor: initial;\n      opacity: 0.4;\n    "])));
}, function (_a) {
    var disabled = _a.disabled, isActive = _a.isActive, isStartOrEnd = _a.isStartOrEnd;
...
function Day(_a) {
    var day = _a.day, isActive = _a.isActive, isStartOrEnd = _a.isStartOrEnd, disabled = _a.disabled, onDaySelect = _a.onDaySelect, date = _a.date;
    ...
    return (React__default.createElement(StyledDay, { role: "button", onClick: function () { return onDaySelect(date); }, disabled: disabled, isActive: isActive, isStartOrEnd: isStartOrEnd, height: "36px", width: "36px", background: background, boxShadow: "1px 0 0 0 " + borderColor + ",\n        0 1px 0 0 " + borderColor + ",\n        1px 1px 0 0 " + borderColor + ",\n        1px 0 0 0 " + borderColor + " inset,\n        0 1px 0 0 " + borderColor + " inset" },
        React__default.createElement(Flex, { justifyContent: "center", alignItems: "center", height: "100%", width: "100%" },
            React__default.createElement(Text, { color: color, fontFamily: "Montserrat", fontWeight: 500, fontSize: "14px" }, day))));
}
...
var Month = function (_a) {
    var year = _a.year, month = _a.month, firstDayOfWeek = _a.firstDayOfWeek, isDateBlocked = _a.isDateBlocked, isDateSelected = _a.isDateSelected, isStartOrEndDate = _a.isStartOrEndDate, onDaySelect = _a.onDaySelect;
    var _b = useMonth({ year: year, month: month, weekStartsOn: firstDayOfWeek }), days = _b.days, weekDays = _b.weekDays, monthLabel = _b.monthLabel;
    return (React__default.createElement("div", null,
        React__default.createElement(Flex, { justifyContent: "center", mb: "28px" },
            React__default.createElement(MonthLabel, { label: monthLabel })),
        React__default.createElement(Grid, { gridTemplateColumns: "repeat(7, 36px)" }, weekDays.map(function (day) { return (React__default.createElement(Flex, { key: day, justifyContent: "center", mb: "16px" },
            React__default.createElement(MonthLabel$1, { label: day }))); })),
        React__default.createElement(Grid, { gridTemplateColumns: "repeat(7, 36px)" }, days.map(function (day, index) {
            if (typeof day === 'object') {
                return (React__default.createElement(Day$1, { isActive: isDateSelected(day.date), date: day.date, key: day.day, day: day.day, disabled: isDateBlocked(day.date), isStartOrEnd: isStartOrEndDate(day.date), onDaySelect: onDaySelect }));
            }
...
var Box = styled('div')(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  box-sizing: border-box;\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  box-sizing: border-box;\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), gridArea, height, space, width, position, top, left, right, bottom);
...
function CaretIcon(_a) {
    var height = _a.height, width = _a.width, color = _a.color, _b = _a.className, className = _b === void 0 ? '' : _b;
    return (React__default.createElement("svg", { width: width, height: height, className: className, color: color, viewBox: "0 0 14 14", xmlns: "http://www.w3.org/2000/svg" },
        React__default.createElement("path", { fill: "currentColor", fillRule: "nonzero", d: "M9.015 11.15c-.027-.18-.04-.39-.067-.585a3.958 3.958 0 0 1-4.48-.056C2.663 9.241 2.142 6.663 3.292 4.74c1.217-2.02 3.797-2.592 5.696-1.282.589.404 1.03.934 1.35 1.533l-1.216.808L13 7.917l-.174-4.556-1.056.696a5.812 5.812 0 0 0-1.846-2.062C7.25.155 3.64.935 1.901 3.765c-1.672 2.717-.95 6.382 1.605 8.194a5.535 5.535 0 0 0 5.616.501c0-.083 0-.167-.013-.264a9.193 9.193 0 0 0-.094-1.046z" })));
}
...
function ResetDates(_a) {
    ...
    return (React__default.createElement(Flex, { role: "button", onClick: onResetDates, alignItems: "center" },
        React__default.createElement(CaretIcon, { height: "14px", width: "14px", color: "58595B" }),
        React__default.createElement(Text, { ml: "8px", mt: "1px", lineHeight: 1.18, fontFamily: "Montserrat", fontSize: "11px", color: "#343132" }, "Reset dates")));
}
...
function CaretIcon$1(_a) {
    ...
    return (React__default.createElement("svg", { width: width, height: height, className: className, color: color, transform: "rotate(" + angle + " 0 0)", viewBox: "0 0 9 6", xmlns: "http://www.w3.org/2000/svg" },
        React__default.createElement("path", { fill: "currentColor", fillRule: "evenodd", stroke: "currentColor", d: "M4.058 4.594L1.185 1.72a.312.312 0 1 1 .442-.442L4.5 4.152l2.873-2.873a.312.312 0 1 1 .442.442L4.723 4.812a.316.316 0 0 1-.446 0l-.219-.218z" })));
}
//# sourceMappingURL=CaretIcon.js.map

//# sourceMappingURL=index.js.map

var StyledNavButton = styled('button')(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"], ["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])), width, height, background, space, border);
function NavButton(_a) {
    var type = _a.type;
    return (React__default.createElement(StyledNavButton, { width: "30px", height: "30px", background: "#ffffff", border: "1px solid #929598", p: "0", type: "button" },
        React__default.createElement(CaretIcon$1, { width: "18px", height: "11px", color: "#808285", direction: type === 'next' ? 'right' : 'left' })));
}
...
function Datepicker(_a) {
    var startDate = _a.startDate, endDate = _a.endDate, minBookingDate = _a.minBookingDate, maxBookingDate = _a.maxBookingDate, focusedInput = _a.focusedInput, numberOfMonths = _a.numberOfMonths, onDateChange = _a.onDateChange, firstDayOfWeekProp = _a.firstDayOfWeek, _b = _a.displayFormat, displayFormat = _b === void 0 ? 'MM/DD/YYYY' : _b, _c = _a.phrases, phrases = _c === void 0 ? datepickerPhrases : _c;
    ...
    }), activeMonths = _d.activeMonths, isDateSelected = _d.isDateSelected, isStartOrEndDate = _d.isStartOrEndDate, isDateBlocked = _d.isDateBlocked, firstDayOfWeek = _d.firstDayOfWeek, onDaySelect = _d.onDaySelect, onResetDates = _d.onResetDates;
    console.log(startDate);
    return (React__default.createElement(StyledDatepicker, { background: "#ffffff", p: "32px", borderRadius: "2px" },
        React__default.createElement(DateWrapper, null,
            React__default.createElement(Grid, { gridTemplateColumns: "126px 75px 126px" },
                React__default.createElement(Date$1, { title: phrases.datepickerStartDateLabel, date: getInputValue(startDate, displayFormat, phrases.datepickerStartDatePlaceholder), isActive: focusedInput === START_DATE }),
                React__default.createElement(Flex, { justifyContent: "center", alignItems: "center" },
                    React__default.createElement(ArrowIcon, { height: "12px", width: "15px", color: "#929598" })),
                React__default.createElement(Date$1, { title: phrases.datepickerEndDateLabel, date: getInputValue(endDate, displayFormat, phrases.datepickerEndDatePlaceholder), isActive: focusedInput === END_DATE }))),
        React__default.createElement(Box, { mt: "28px", position: "relative" },
            React__default.createElement(Box, { position: "absolute", top: "-5px", left: "0" },
                React__default.createElement(NavButton, { type: "prev" })),
            React__default.createElement(Box, { position: "absolute", top: "-5px", right: "0" },
                React__default.createElement(NavButton, { type: "next" })),
            React__default.createElement(Grid, { gridTemplateColumns: "repeat(2, 1fr)", gridGap: "0 32px" }, activeMonths.map(function (month) { return (React__default.createElement(Month, { key: month.year + "-" + month.month, year: month.year, month: month.month, firstDayOfWeek: firstDayOfWeek, isDateBlocked: isDateBlocked, isDateSelected: isDateSelected, isStartOrEndDate: isStartOrEndDate, onDaySelect: onDaySelect })); }))),
        React__default.createElement(Box, { mt: "32px" },
            React__default.createElement(ResetDates, { onResetDates: onResetDates }))));
}
...
function DateRangeInput(_a) {
    var startDate = _a.startDate, endDate = _a.endDate, minBookingDate = _a.minBookingDate, maxBookingDate = _a.maxBookingDate, firstDayOfWeek = _a.firstDayOfWeek, onFocusChange = _a.onFocusChange, numberOfMonths = _a.numberOfMonths, focusedInput = _a.focusedInput, onDateChange = _a.onDateChange, _b = _a.displayFormat, displayFormat = _b === void 0 ? 'MM/DD/YYYY' : _b, _c = _a.phrases, phrases = _c === void 0 ? dateRangeInputPhrases : _c;
    return (React__default.createElement("div", null,
        React__default.createElement(Grid, { gridTemplateColumns: "194px 39px 194px" },
            React__default.createElement(Input, { id: "startDate", ariaLabel: phrases.startDateAriaLabel, placeholder: phrases.startDatePlaceholder, value: getInputValue(startDate, displayFormat, ''), onClick: function () { return onFocusChange(START_DATE); } }),
            React__default.createElement(Flex, { alignItems: "center", justifyContent: "center" },
                React__default.createElement(StyledArrowIcon, { width: "15px", height: "12px", color: "#ffffff", opacity: 0.4 })),
            React__default.createElement(Input, { id: "startDate", ariaLabel: phrases.endDateAriaLabel, placeholder: phrases.endDatePlaceholder, value: getInputValue(endDate, displayFormat, ''), onClick: function () { return onFocusChange(END_DATE); } })),
        React__default.createElement(Datepicker, { startDate: startDate, endDate: endDate, minBookingDate: minBookingDate, maxBookingDate: maxBookingDate, firstDayOfWeek: firstDayOfWeek, numberOfMonths: numberOfMonths, focusedInput: focusedInput, displayFormat: displayFormat, onDateChange: onDateChange })));
}
