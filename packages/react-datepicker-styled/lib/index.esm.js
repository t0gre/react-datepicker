...
function Day(_a) {
    ...
    return (React.createElement(StyledDay, { disabled: disabled, isActive: isActive, isStartOrEnd: isStartOrEnd, height: "36px", width: "36px", background: background, boxShadow: "1px 0 0 0 " + borderColor + ",\n        0 1px 0 0 " + borderColor + ",\n        1px 1px 0 0 " + borderColor + ",\n        1px 0 0 0 " + borderColor + " inset,\n        0 1px 0 0 " + borderColor + " inset" },
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Grid, { gridTemplateColumns: "repeat(7, 36px)" }, days.map(function (day, index) {
            if (typeof day === 'object') {
                return (React.createElement(Day$1, { isActive: isDateSelected(day.date), key: day.day, day: day.day, disabled: isDateBlocked(day.date), isStartOrEnd: isStartOrEndDate(day.date) }));
            }
...
function Datepicker(_a) {
    ...
    return (React.createElement(StyledDatepicker, { background: "#ffffff", p: "32px", borderRadius: "2px" },
        ...
        React.createElement(Box, { mt: "32px" },
            React.createElement(ResetDates, null))));
}
