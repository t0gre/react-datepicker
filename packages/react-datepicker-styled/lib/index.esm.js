...
var ot,
  ...
  yt = {
    ...
    format: (function() {
      ...
      return (
        ...
        {formatters: s, formattingTokensRegExp: gt(s)}
      )
    })(),
  },
  vt = function(e, t) {
  ...
  St = {
    ...
    YY: function(e) {
      return Et(e.getFullYear(), 4).substr(2)
    },
    YYYY: function(e) {
      return Et(e.getFullYear(), 4)
    },
    GG: function(e) {
      return String(ct(e)).substr(2)
    },
    GGGG: function(e) {
      return ct(e)
    },
    ...
    mm: function(e) {
      return Et(e.getMinutes(), 2)
    },
    s: function(e) {
      return e.getSeconds()
    },
    ss: function(e) {
      return Et(e.getSeconds(), 2)
    },
    S: function(e) {
      return Math.floor(e.getMilliseconds() / 100)
    },
    SS: function(e) {
      return Et(Math.floor(e.getMilliseconds() / 10), 2)
    },
    SSS: function(e) {
      return Et(e.getMilliseconds(), 3)
    },
    Z: function(e) {
      return Mt(e.getTimezoneOffset(), ':')
    },
    ZZ: function(e) {
      return Mt(e.getTimezoneOffset())
    },
...
function Mt(e, t) {
  ...
  var n = e > 0 ? '-' : '+',
    r = Math.abs(e),
    o = r % 60
  return n + Et(Math.floor(r / 60), 2) + t + Et(o, 2)
}
function Et(e, t) {
...
var Tt = function(e, t, n) {
  ...
  Ct = function(e, t, n) {
    var r = t ? String(t) : 'YYYY-MM-DDTHH:mm:ss.SSSZ',
      o = (n || {}).locale,
      a = yt.format.formatters,
      i = yt.format.formattingTokensRegExp
    o &&
      o.format &&
      o.format.formatters &&
          ...
          var t = void 0 === e ? {} : e,
            ...
            a =
              void 0 === o
                ...
                : o,
            i = new Date()
          return Vt(Ht(qt(i), r), Ht(Rt(i), r)).reduce(function(e, t) {
            return e.push(a(t)), e
          }, [])
...
function Kt(e) {
  var t = Zt(e)
  return {year: Nt(t), month: Bt(t), date: t}
}
function en(e, t) {
  var n = Kt(t || Jt()),
    r = n.date,
  ...
  return (
    e > 1 &&
      (o = Array.from(Array(e - 1).keys()).reduce(function(e) {
        return (r = It(e[e.length - 1].date, 1)), e.concat([Kt(r)])
      }, o)),
    o
  )
}
function tn(e, t, n) {
  ...
  return Array.from(Array(t).keys()).reduce(function(e) {
    return (r = It(r, n)), e.concat([Kt(r)])
  }, [])
}
function nn(e, t, n) {
  return e && 'string' == typeof t ? Lt(e, t) : e && 'function' == typeof t ? t(e) : n
}
var rn = 'startDate',
  on = 'endDate'
function an(e) {
    ...
    v = n(
      function(e) {
        return (function(e, t, n, r) {
          return !!((t && Gt(e, t)) || (n && _t(e, n)) || (r && r(e)))
        })(e, i, u)
      },
      [i, u],
    )
  return {
    ...
    onResetDates: function() {
      s({startDate: null, endDate: null, focusedInput: rn})
    },
    onDaySelect: function(e) {
      ;(a === on && r && Gt(e, r)) || (a === rn && o && _t(e, o))
        ? s({endDate: null, startDate: e, focusedInput: on})
        : a === rn
        ? s({endDate: o, startDate: e, focusedInput: on})
        : a === on && r && !Gt(e, r) && s({startDate: r, endDate: e, focusedInput: null})
    },
...
function kn(t) {
  ...
  return e.createElement(
    ...
    e.createElement(
      ...
      e.createElement(hn, {width: '12px', height: '12px', color: '#BCBEC0'}),
    ),
    e.createElement(xn, {
      border: '0',
      px: '44px',
...
var Pn,
  ...
  Vn = function(t) {
    var n = t.year,
      ...
      s = t.onDaySelect,
      c = Qt({year: n, month: r, weekStartsOn: o}),
      l = c.days,
      f = c.weekDays,
      p = c.monthLabel
    return e.createElement(
      'div',
      null,
      e.createElement(dn, {justifyContent: 'center', mb: '28px'}, e.createElement(Fn, {label: p})),
      e.createElement(
        pn,
  ...
  return e.createElement(
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(On, {
          ...
          date: nn(n, f, d.datepickerStartDatePlaceholder),
          isActive: i === rn,
        }),
        e.createElement(
          dn,
          {justifyContent: 'center', alignItems: 'center'},
          e.createElement(wn, {height: '12px', width: '15px', color: '#929598'}),
        ),
        e.createElement(On, {
          title: d.datepickerEndDateLabel,
          date: nn(r, f, d.datepickerEndDatePlaceholder),
          isActive: i === on,
        }),
      ),
    ),
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(Nn, {type: 'prev', onClick: k}),
      ),
      e.createElement(
        mn,
        {position: 'absolute', top: '-5px', right: '0'},
        e.createElement(Nn, {type: 'next', onClick: w}),
      ),
      e.createElement(
        pn,
    ...
    e.createElement(mn, {mt: '32px'}, e.createElement(Rn, {onResetDates: x})),
  )
}
var Jn,
  qn = i(wn)(Jn || (Jn = c(['\n  ', '\n'], ['\n  ', '\n'])), Oe)
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(
          ...
          e.createElement(qn, {width: '15px', height: '12px', color: '#ffffff', opacity: 0.4}),
        ),
        e.createElement(kn, {
          id: 'startDate',
