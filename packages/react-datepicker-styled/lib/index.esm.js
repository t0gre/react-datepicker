import React, { cloneElement, createContext, Component, createElement, useMemo, useCallback } from 'react';
...
function useDatepicker(_a) {
  ...
  var isDateSelected$1 = useCallback(function (date) {
    return isDateSelected(date, startDate, endDate);
  }, [startDate, endDate]);
  var isStartOrEndDate$1 = useCallback(function (date) {
    return isStartOrEndDate(date, startDate, endDate);
  }, [startDate, endDate]);
  var isDateBlocked$1 = useCallback(function (date) {
...
function Date$1(_a) {
    ...
    return (React.createElement("div", null,
        React.createElement(Text, { fontFamily: "Montserrat", fontSize: "11px", color: "#929598", mb: "8px" }, title),
        React.createElement(StyledDate, { as: "span", color: "#001217", fontSize: "24px", fontWeight: 500, fontFamily: "Montserrat", pb: "15px", isActive: isActive }, date)));
}
...
var MonthLabel = function (_a) {
    var label = _a.label;
    return (React.createElement(Text, { fontFamily: "Montserrat", fontSize: "14px", fontWeight: 600, lineHeight: 1.57, color: "#343132" }, label));
};
...
var MonthLabel$1 = function (_a) {
    var label = _a.label;
    return (React.createElement(Text, { fontFamily: "Montserrat", fontSize: "11px", fontWeight: 500, color: "#929598" }, label));
};
...
function Day(_a) {
    ...
    return (React.createElement(StyledDay, { role: "button", onClick: function () { return onDaySelect(date); }, disabled: disabled, isActive: isActive, isStartOrEnd: isStartOrEnd, height: "36px", width: "36px", background: background, boxShadow: "1px 0 0 0 " + borderColor + ",\n        0 1px 0 0 " + borderColor + ",\n        1px 1px 0 0 " + borderColor + ",\n        1px 0 0 0 " + borderColor + " inset,\n        0 1px 0 0 " + borderColor + " inset" },
        React.createElement(Flex, { justifyContent: "center", alignItems: "center", height: "100%", width: "100%" },
            React.createElement(Text, { color: color, fontFamily: "Montserrat", fontWeight: 500, fontSize: "14px" }, day))));
}
var Day$1 = React.memo(Day);
...
var Month = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement(Flex, { justifyContent: "center", mb: "28px" },
            React.createElement(MonthLabel, { label: monthLabel })),
        React.createElement(Grid, { gridTemplateColumns: "repeat(7, 36px)" }, weekDays.map(function (day) { return (React.createElement(Flex, { key: day, justifyContent: "center", mb: "16px" },
            React.createElement(MonthLabel$1, { label: day }))); })),
        React.createElement(Grid, { gridTemplateColumns: "repeat(7, 36px)" }, days.map(function (day, index) {
            if (typeof day === 'object') {
                return (React.createElement(Day$1, { isActive: isDateSelected(day.date), date: day.date, key: day.day, day: day.day, disabled: isDateBlocked(day.date), isStartOrEnd: isStartOrEndDate(day.date), onDaySelect: onDaySelect }));
            }
...
function CaretIcon(_a) {
    var height = _a.height, width = _a.width, color = _a.color, _b = _a.className, className = _b === void 0 ? '' : _b;
    return (React.createElement("svg", { width: width, height: height, className: className, color: color, viewBox: "0 0 14 14", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fill: "currentColor", fillRule: "nonzero", d: "M9.015 11.15c-.027-.18-.04-.39-.067-.585a3.958 3.958 0 0 1-4.48-.056C2.663 9.241 2.142 6.663 3.292 4.74c1.217-2.02 3.797-2.592 5.696-1.282.589.404 1.03.934 1.35 1.533l-1.216.808L13 7.917l-.174-4.556-1.056.696a5.812 5.812 0 0 0-1.846-2.062C7.25.155 3.64.935 1.901 3.765c-1.672 2.717-.95 6.382 1.605 8.194a5.535 5.535 0 0 0 5.616.501c0-.083 0-.167-.013-.264a9.193 9.193 0 0 0-.094-1.046z" })));
}
...
function ResetDates(_a) {
    ...
    return (React.createElement(Flex, { role: "button", onClick: onResetDates, alignItems: "center" },
        React.createElement(CaretIcon, { height: "14px", width: "14px", color: "58595B" }),
        React.createElement(Text, { ml: "8px", mt: "1px", lineHeight: 1.18, fontFamily: "Montserrat", fontSize: "11px", color: "#343132" }, "Reset dates")));
}
...
function CaretIcon$1(_a) {
    ...
    return (React.createElement("svg", { width: width, height: height, className: className, color: color, transform: "rotate(" + angle + " 0 0)", viewBox: "0 0 9 6", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { fill: "currentColor", fillRule: "evenodd", stroke: "currentColor", d: "M4.058 4.594L1.185 1.72a.312.312 0 1 1 .442-.442L4.5 4.152l2.873-2.873a.312.312 0 1 1 .442.442L4.723 4.812a.316.316 0 0 1-.446 0l-.219-.218z" })));
}
...
function NavButton(_a) {
    var type = _a.type;
    return (React.createElement(StyledNavButton, { width: "30px", height: "30px", background: "#ffffff", border: "1px solid #929598", p: "0", type: "button" },
        React.createElement(CaretIcon$1, { width: "18px", height: "11px", color: "#808285", direction: type === 'next' ? 'right' : 'left' })));
}
...
function Datepicker(_a) {
    ...
    return (React.createElement(StyledDatepicker, { background: "#ffffff", p: "32px", borderRadius: "2px" },
        ...
        React.createElement(Box, { mt: "28px", position: "relative" },
            ...
            React.createElement(Box, { position: "absolute", top: "-5px", right: "0" },
                React.createElement(NavButton, { type: "next" })),
            React.createElement(Grid, { gridTemplateColumns: "repeat(2, 1fr)", gridGap: "0 32px" }, activeMonths.map(function (month) { return (React.createElement(Month, { key: month.year + "-" + month.month, year: month.year, month: month.month, firstDayOfWeek: firstDayOfWeek, isDateBlocked: isDateBlocked, isDateSelected: isDateSelected, isStartOrEndDate: isStartOrEndDate, onDaySelect: onDaySelect })); }))),
        React.createElement(Box, { mt: "32px" },
            React.createElement(ResetDates, { onResetDates: onResetDates }))));
}
...
function DateRangeInput(_a) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Datepicker, { startDate: startDate, endDate: endDate, minBookingDate: minBookingDate, maxBookingDate: maxBookingDate, firstDayOfWeek: firstDayOfWeek, numberOfMonths: numberOfMonths, focusedInput: focusedInput, displayFormat: displayFormat, onDateChange: onDateChange })));
}
